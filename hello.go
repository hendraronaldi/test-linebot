	...
	for _, event := range events {
		if event.Type == linebot.EventTypeMessage {
			...
			case *linebot.TextMessage:
				...
				newFlex := "Flex{Header{}|Hero{https://firebasestorage.googleapis.com/v0/b/talkabot-a9388.appspot.com/o/getlargeimage.png?alt=media&token=add458d4-fc1e-459b-b92d-04355d2392db}|Body{Vertical{FlexAction{1:1:1:1:1:1:1:Rincian Toko}~FlexAction{1:1:1:1:1:1:2:Menu}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:1:Rincian Toko}~FlexAction{1:1:1:1:1:1:2:Menu}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:1:Rincian Toko}~FlexAction{1:1:1:1:1:1:2:Menu}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}~FlexAction{1:1:1:1:1:1:3:Tolongin Beliin}}}|Footer{}}"
