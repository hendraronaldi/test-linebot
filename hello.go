	...
	for _, event := range events {
		if event.Type == linebot.EventTypeMessage {
			...
			case *linebot.TextMessage:
				...
				//Button
				button := "Button{Test;1:1:1:biodata|2:1:lalala;Test;1:1:1:biodata|2:1:lalala;Test;1:1:1:biodata|2:1:lalala;Test;1:1:1:biodata|2:1:lalala;Test;1:1:1:biodata|2:1:lalala}"
